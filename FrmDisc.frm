...
Private Sub Form_Load()
    ...
    GenClass.fleLogin mvUserid, "Accessed Stagg Discipline Definition", Date, Time
    Call FormCentreMDI(Me)
    Set wrktemp = DBEngine.Workspaces(0)
    Set db1 = wrktemp.OpenDatabase(DBpath, True)
    Set rstDefTab = db1.OpenRecordset("DefDisc", dbOpenDynaset)
