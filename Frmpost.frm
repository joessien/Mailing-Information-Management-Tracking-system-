...
Dim db6 As Database, wrktemp As Workspace, postTab As Recordset
...
Private Sub CmdBrow_Click()
    ...
    Set GenView.datGeneral.Recordset = postTab
...
Private Sub CmdDel_Click()
   ...
   End If
    ...
    If i = vbYes Then
        postTab.Delete
        postTab.MoveNext
        If postTab.EOF Then postTab.MovePrevious
    End If
DelClear:
    showdata
    Exit Sub
...
Private Sub Form_Load()
    ...
    Set postTab = db6.OpenRecordset("PostTab", dbOpenDynaset)
...
Public Sub showdata()
     If Not (postTab.EOF And postTab.BOF) Then
        xCode = Right(postTab("Code"), 3)
        xDesc = postTab("desc")
    End If
End Sub
