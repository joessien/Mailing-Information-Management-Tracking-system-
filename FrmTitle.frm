...
Begin VB.Form FrmTitle 
   ...
   Begin VB.Label fhdr 
      ...
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Designation Definition"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
...
On Error GoTo PError
    GenClass.fleLogin mvUserid, "Accessed Title Definition", Date, Time
    Call FormCentreMDI(Me)
    Set wrktemp = DBEngine.Workspaces(0)
    Set db1 = wrktemp.OpenDatabase(DBpath, True)
    Set rstDefTab = db1.OpenRecordset("Deftitle", dbOpenDynaset)
