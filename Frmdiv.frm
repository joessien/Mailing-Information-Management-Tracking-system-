...
Begin VB.Form FrmDPdiv 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      _ExtentY        =   1296
      _StockProps     =   15
      Caption         =   "Class/Formation Definition"
      BackColor       =   8421376
...
Dim db6 As Database, wrktemp As Workspace, Divtab As Recordset
...
Private Sub CmdBrow_Click()
    ...
    Set GenView.datGeneral.Recordset = Divtab
...
Private Sub CmdDel_Click()
   ...
   End If
    ...
    If i = vbYes Then
        Divtab.Delete
        Divtab.MoveNext
        If Divtab.EOF Then Divtab.MovePrevious
    End If
DelClear:
    showdata
    Exit Sub
...
Private Sub Form_Load()
    ...
    Set Divtab = db6.OpenRecordset("Divtab", dbOpenDynaset)
